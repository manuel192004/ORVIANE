...
function buildUserPrompt(payload, rulesReply) {
  return [
    ...
    [
      ...
      'Si pide precio o valoración, usa la estimación base si existe: metal por gramo, piedra por quilate o pieza, peso, mano de obra y rango. No contradigas ese rango.',
